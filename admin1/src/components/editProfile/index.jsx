...
const EditProfile = ({ params }) => {
    ...
    const [profilePic, setProfilePic] = useState(params.row.picturePath)
    ...
    const handleEditProfile = async (values, onSubmitProps) => {
        ...
        const editUserRes = await fetch(`http://localhost:3001/users/edit/${params.row._id}`, {
            method: 'PATCH',
            headers: {
        ...
        // }
        dispatch(setUsers(updatedProfile))
                            ...
                            <Box sx={{ display: "flex", flexDirection: isNonMobile ? "row" : "column", justifyContent: "center", gap: 2 }}>
                                <Box sx={{ display: "flex", flex: 1, flexDirection: "column", p: 1 }}>
                                    <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                                        <Avatar src={params.row.picturePath} sx={{ height: "2.5rem", width: "2.5rem", borderRadius: "10%" }}></Avatar>
                                        <Typography>
                                            {params.row.userName}
                                        </Typography>
                                    </Box>
